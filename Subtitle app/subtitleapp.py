...
class subtitle_creator(QMainWindow):
    ...
    def initUI(self):
        ...
        self.video_input.setPlaceholderText("Insert video files only")
    ...
    '''the results are in dictionary format which contain key 
    "text"{str}(The full transcription of the entire audio.),
    "segments"{list}(A list of subtitle segments with timestamps.)
    "language"{str}(Detected language (e.g., "en", "fr", etc.))'''
